...
#define	ILI9341_CS_PIN		4			// <= /CS pin (chip-select, LOW to get attention of ILI9341, HIGH and it ignores SPI bus) def 10
#define	ILI9341_DC_PIN		24			// <= DC pin (1=data or 0=command indicator line) also called RS
